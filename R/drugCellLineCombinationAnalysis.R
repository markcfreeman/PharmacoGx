...
multiDrugCellLineCombinationAnalysis <- setRefClass("multiDrugCellLineCombinationAnalysis",
                                                    ...
                                                    methods = list(
                                                      ...
                                                      plotResults = function()
                                                      {
                                                        for (drug in drugs)
                                                        {
                                                          ...
                                                          points(exp(interpolatedLogConcentrations),
                                                                 PharmacoGx:::.Hill(exp(interpolatedLogConcentrations),
                                                                                    c(exp(hillModelFits[[drug]]$m$getPars()[["logN"]]),
                                                                                      0,
                                                                                      exp(hillModelFits[[drug]]$m$getPars()[["logD0"]])),
                                                                                    pch = 20,
                                                                                    cex = 0.1,
                                                                                    col = "blue")
                                                                 abline(h = 0.1,
                                                        ...
                                                        for (drugPair in drugPairs())
                                                        {
                                                          ...
                                                          predictedViabilities <- outer(interpolatedLogXs,
                                                                                        interpolatedLogYs,
                                                                                        function(x, y){return(PharmacoGx:::.Katzir2(exp(x),
                                                                                                                                    exp(y),
                                                    ...
                                                    fitHillModelToData <- function(data, maxLogN = 2, minLogN = -maxLogN)
                                                    {
                                                      ...
                                                      hillModelFit <- nls(formula = y ~ PharmacoGx:::.Hill(x, c(exp(logN), 0, exp(logD0))),
                                                                                     ...
                                                                                     minLogA = -maxLogA)
                                                    {
                                                      if (modelType == "lowData")
                                                      {
                                                        ...
                                                        startResidual1 <- sum((y - PharmacoGx:::.Katzir2(xi = data[, "Drug A Concentration"],
                                                                                                         xj = data[, "Drug B Concentration"],
                                                        ...
                                                        fitResidual1 <- Inf
                                                        try(expr = {fit1 <- nls(formula = y ~ PharmacoGx:::.Katzir2(xi, xj, logD0i, logD0j, 0, 0, 0, logAji),
                                                                                data = list(y = data[, "Viability"],
                                                                                            xi = data[, "Drug A Concentration"],
                                                                                            xj = data[, "Drug B Concentration"]),
                                                                                start = start1,
                                                        ...
                                                        startResidual2 <- sum((data[, "Viability"] -
                                                                                 PharmacoGx:::.Katzir2(xi = data[, "Drug A Concentration"],
                                                                                                       xj = data[, "Drug B Concentration"],
                                                                                                       ...
                                                                                                       logAji = 0)) ^ 2)
                                                        fitResidual2 <- Inf
                                                        try(expr = {fit2 <- nls(formula = y ~ PharmacoGx:::.Katzir2(xi, xj, logD0i, logD0j, 0, 0, logAij, 0),
                                                                                data = list(y = data[, "Viability"],
                                                                                            xi = data[, "Drug A Concentration"],
                                                                                            xj = data[, "Drug B Concentration"]),
                                                                                start = start2,
                                                      ...
                                                      else if (modelType == "unidirectional")
                                                      {
                                                        ...
                                                        fitResidual1 <- Inf
                                                        try(expr = {fit1 <- nls(formula = y ~ PharmacoGx:::.Katzir2(xi, xj, logD0i, logD0j, logNi, logNj, logAij, 0),
                                                                                data = list(y = data[, "Viability"],
                                                                                            xi = data[, "Drug A Concentration"],
                                                                                            xj = data[, "Drug B Concentration"]),
                                                                                start = start1,
                                                        ...
                                                        fitResidual2 <- Inf
                                                        try(expr = {fit2 <- nls(formula = y ~ PharmacoGx:::.Katzir2(xi, xj, logD0i, logD0j, logNi, logNj, 0, logAji),
                                                                                data = list(y = data[, "Viability"],
                                                                                            xi = data[, "Drug A Concentration"],
                                                                                            xj = data[, "Drug B Concentration"]),
                                                                                start = start2,
                                                      ...
                                                      else if (modelType == "bidirectional")
                                                      {
                                                        ...
                                                        startResidual <- sum((data[, "Viability"] -
                                                                                PharmacoGx:::.Katzir2(data[, "Drug A Concentration"],
                                                                                                      ...
                                                                                                      start[["logAji"]])) ^ 2)
                                                        fitResidual <- Inf
                                                        try(expr = {fit <- nls(formula = y ~ PharmacoGx:::.Katzir2(xi, xj, logD0i, logD0j, logNi, logNj, logAij, logAji),
                                                                               data = list(y = data[, "Viability"],
                                                                                           xi = data[, "Drug A Concentration"],
                                                                                           xj = data[, "Drug B Concentration"]),
                                                                               start = start,
                                                    ...
                                                    analyzeInteraction <- function (drugs, cellLine, tissueType, dataset, modelType)
                                                    {
                                                      ...
                                                      if (modelType %in% c("bidirectional", "unidirectional"))
                                                      {
                                                        ...
                                                        for (drug in drugs)
                                                        {
                                                          ...
                                                          hillModelFits[[drug]] <- nls(formula = y ~ PharmacoGx:::.Hill(x, c(exp(logN), 0, exp(logD0))),
                                                                                  ...
                                                                                  hillModelFitConfidenceIntervals)
                                                    {
                                                      ...
                                                      residuals <- data[, "Viability"] - PharmacoGx:::.Katzir2(xi = data[, "Drug A Concentration"],
                                                                                                               xj = data[, "Drug B Concentration"],
